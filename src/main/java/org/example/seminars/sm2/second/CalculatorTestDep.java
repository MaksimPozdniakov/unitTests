...
public class CalculatorTestDep {
    ...
    public static void main(String[] args) {
        ...
        // но нужно проверить, что все ошибки проверяются в тестах. (Заготовки метода уже есть в классе `org.example.seminars.sm2.second.Calculator` - `calculatingDiscount`)
